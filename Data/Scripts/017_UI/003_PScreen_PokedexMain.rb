...
=end
  ...
  def pbRefresh
    ...
    if @searchResults
      ...
      textpos.push([$Trainer.pokedex.seen_count(region: region).to_s,182,302,1,base,shadow])
      textpos.push([_INTL("Owned:"),42,334,0,base,shadow])
      textpos.push([$Trainer.pokedex.owned_count(region: region).to_s,182,334,1,base,shadow])
    end
    # Draw all text
